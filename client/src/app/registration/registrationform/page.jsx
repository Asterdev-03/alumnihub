          ...
          <>
            ...
            <div className={styles.registration_main_container}>
              ...
              <div style={{ margin: "0.5rem" }}>
                ...
                />
                <Typography>
                 I am aware that I am registering to alumni community website which is completely managed by only cse students. It is not linked to jyothi College or CSE department officially.
                </Typography>
                <br />
                <Button
                  onClick={() => {
