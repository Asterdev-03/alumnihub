      ...
      <div className={styles.footer_section}>
        ...
        <div className={styles.footer_top}>
          ...
          <div className={`${styles.footer_item} ${styles.footer_item1} `}>
            <h4 className={styles.footer_link_heading}>alumni</h4>
            <p>
              Welcome to JYOTHI Alumni Batch Page. This page is designed in view of
          ...
          <div className={`${styles.footer_item} ${styles.footer_item3} `}>
            ...
            <ul>
              <li>
                <Link target="_blank" href={"https://www.jecc.ac.in/"}>
                  JYOTHI Website{" "}
                  <OpenInNewIcon className={styles.font_size_inherit} />{" "}
                </Link>
              </li>
              <li>
                <Link target="_blank" href={"https://feebook.southindianbank.com/FeeBookUser/org?id=371"}>
                  JYOTHI payment portal{" "}
                  <OpenInNewIcon className={styles.font_size_inherit} />{" "}
                </Link>
              </li>
              <li>
                <Link
                  target="_blank"
                  href={
                    "https://www.linkedin.com/school/jyothi-engineering-college-cheruthuruthy/"
                  }
                >
                  JYOTHI LinkedIn page{" "}
                  <OpenInNewIcon className={styles.font_size_inherit} />
                </Link>
              </li>
        ...
        <div className={styles.footer_bottom}>
          <p>
            Copyrights ©{`${currentYear}`} jyothi bTech. All rights reserved ||
